 ...
 * If response from API is error, Promise object format will be { error: MMError() }
 * If response from API is a bundle of errors, Promise object format will be { error: [ MMError() ] }
 */
